const AND_GATE_COMPONENT = "AND_GATE";
COMPONENT_LIST.push(AND_GATE_COMPONENT)
...
class ANDGate {
    ...
    draw() {
        ...
        text("AND", this.x + CAMERA_DATA.x_offset, this.y + CAMERA_DATA.y_offset);
